...
@section('nav')
    <ul class="list-inline">
        ...
        <li class="list-inline-item pr-3"><a href="/mapel" class="nav-link active">Mapel</a></li>
...
<div class="container">
  ...
  <div class="card mt-4">
      <div class="card-body">
          <a href="javascript:void(0)" class="btn btn-outline-success mb-3" id="tombol-tambah">Tambah Mapel</a>
          <table class="table table-info table-bordered border-dark table-hover table-lg" id="table-mapel">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h5 class="modal-title text-light" id="ModalTitle">Tambah Mapel</h5>
        </div>
        <div class="modal-body">
          <form id="form-tambah" name="form-tambah" action="{{ action('SubjectController@store') }}" method="POST">
            {{ csrf_field() }}
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-warning">
          <h5 class="modal-title" id="judul-modal-edit">Edit Mapel</h5>
        </div>
        <div class="modal-body">
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-danger">
          <h5 class="modal-title text-light" id="judul-modal-hapus">Hapus Mapel</h5>
        </div>
        <div class="modal-body">
...
@section('JS')
    ...
    <script src="{{ asset('js/dataTable_subject.js') }}"></script>
@endsection