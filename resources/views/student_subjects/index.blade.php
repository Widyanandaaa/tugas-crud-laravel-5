...
@section('title', 'Data Siswa Mapel')
...
@section('nav')
    <ul class="list-inline">
        ...
        <li class="list-inline-item pr-3"><a href="/siswa-mapel" class="nav-link active">Siswa Mapel</a></li>
...
<div class="container">
  ...
  <div class="card mt-4">
      <div class="card-body">
          <a href="javascript:void(0)" class="btn btn-outline-success mb-3" id="tombol-tambah">Tambah Siswa Mapel</a>
          <table class="table table-info table-bordered border-dark table-hover table-lg" id="table-siswa">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h5 class="modal-title text-light" id="ModalTitle">Tambah Data Siswa Mapel</h5>
        </div>
        <div class="modal-body">
          <form id="form-tambah" name="form-tambah" action="{{ action('StudentSubjectController@store') }}" method="POST">
            {{ csrf_field() }}
            <input type="hidden" name="id" id="id">
            <div class="mb-4">
              <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="tambah-nama" name="student_id" required>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-warning">
          <h5 class="modal-title" id="judul-modal-edit">Edit Data Siswa Mapel</h5>
        </div>
        <div class="modal-body">
          <form action="/siswa" method="post" name="form-edit" id="form-edit">
              ...
              <div class="mb-4">
                <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="edit-nama" name="student_id">
                  <option selected>Nama Siswa</option>
                  @foreach ($students as $id => $student)
                      <option value="{{ $id }}">{{ $student }}</option>
                  @endforeach
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-danger">
          <h5 class="modal-title text-light" id="judul-modal-hapus">Hapus Data Siswa</h5>
        </div>
        <div class="modal-body">
...
@section('JS')
    ...
    <script src="{{ asset('js/dataTable_studentSubject.js') }}"></script>
@endsection