...
@section('nav')
    <ul class="list-inline">
        ...
        <li class="list-inline-item pr-3"><a href="/siswa" class="nav-link active">Siswa</a></li>
...
<div class="container">
  ...
  <div class="card mt-4">
      <div class="card-body">
          <a href="javascript:void(0)" class="btn btn-outline-success mb-3" id="tombol-tambah">Tambah Siswa</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h5 class="modal-title text-light" id="ModalTitle">Tambah Data Siswa</h5>
        </div>
        <div class="modal-body">
          <form id="form-tambah" name="form-tambah" action="{{ action('StudentController@store') }}" method="POST">
            {{ csrf_field() }}
            ...
            <div class="mb-3">
              <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="tambah kelas" name="kelas">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-warning">
          <h5 class="modal-title" id="judul-modal-edit">Edit Data Siswa</h5>
        </div>
        <div class="modal-body">
          <form action="/siswa" method="post" name="form-edit" id="form-edit">
              ...
              <div class="mb-3">
              <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="edit-kelas" name="kelas">
...
@section('JS')
    ...
    <script src="{{ asset('js/dataTable_student.js') }}"></script>
@endsection